...
<body class="bg-login">
                ...
                <div class="row row-cols-1 row-cols-lg-2 row-cols-xl-3">
                    <div class="col mx-auto">
                        <div class="mb-4 text-center">
                            <img src="<?php echo BASE_URL; ?>assets/images/logo-i.png" width="120" alt="80" />
                        </div>
                        <div class="card">
                            <div class="card-body">
                                <div class="border p-4 rounded">
                                    ...
                                    <div class="login-separater text-center mb-4"> <span>Ingresa tu correo</span>
                                        <hr />
                                    </div>
                                    <div class="form-body">
    ...
    <script src="<?php echo BASE_URL; ?>assets/js/modulos/login.js?v=5"></script>
</body>
