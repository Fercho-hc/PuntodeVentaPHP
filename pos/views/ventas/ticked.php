...
<body>
    <img src="<?php echo BASE_URL . 'assets/images/logo-i.png'; ?>" alt="">
    ...
    <div class="datos-info">
        <strong><?php echo $data['venta']['identidad']; ?>: </strong> <?php echo $data['venta']['num_identidad']; ?></p>
    ...
    <div class="mensaje">
        ...
        <div class="datos-info">
            <p><strong>Nombre del Vendedor: </strong> <?php echo $_SESSION['nombre_usuario']; ?></p>
            <p><strong>Correo del Vendedor: </strong> <?php echo $_SESSION['correo_usuario']; ?></p>
        </div>
