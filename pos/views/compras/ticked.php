...
<body>
    ...
    <div class="datos-info">
        <p><strong>ID: </strong> <?php echo $data['compra']['ruc']; ?></p>
    ...
    <div class="mensaje">
        <div class="datos-info">
            <p><strong>Nombre del Comprador: </strong> <?php echo $_SESSION['nombre_usuario']; ?></p>
            <p><strong>Correo del Comprador: </strong> <?php echo $_SESSION['correo_usuario']; ?></p>
        </div>
